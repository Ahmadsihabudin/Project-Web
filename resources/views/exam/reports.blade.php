...
<html lang="id">
  <head>
    ...
    <title>Laporan - Pembuat Ujian</title>
      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-download me-2"></i>Ekspor Laporan</button>
            </div>
          </div>
          ...
          <div class="card mb-4">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-3">
                  <label for="reportExam" class="form-label">Ujian</label>
                ...
                <div class="col-md-3">
                  ...
                  <button class="btn btn-primary d-block w-100" id="generateReport"><i class="bi bi-graph-up me-1"></i>Buat Laporan</button>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="text-center text-muted">
                    ...
                    <p>Grafik kinerja akan ditampilkan di sini</p>
                  </div>
                </div>
              </div>
            </div>
