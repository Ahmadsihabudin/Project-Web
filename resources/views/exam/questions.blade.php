...
<html lang="id">
  <head>
    ...
    <title>Soal - Pembuat Ujian</title>
      ...
      <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content">
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <h1 class="h2" id="pageTitle">Bank Soal</h1>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                  <div>
                    <button class="btn btn-outline-danger btn-sm" id="deleteSelected" disabled><i class="bi bi-trash me-1"></i>Hapus Terpilih</button>
                  </div>
                  <nav>
