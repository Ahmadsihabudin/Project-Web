...
<head>
   ...
   <title>Tambah Laporan - Ujian Online</title>
...
<body>
         ...
         <div class="p-4">
            ...
            <div class="page-header">
               <div class="row align-items-center">
                  <div class="col-md-8">
                     <h4 class="mb-2"><i class="bi bi-file-earmark-plus me-2"></i>Tambah Laporan</h4>
                     <p class="mb-0">Buat laporan baru untuk analisis ujian</p>
                  </div>
                           ...
                           <div class="form-section">
                              ...
                              <div class="mb-3">
                                 ...
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="include_chart" name="include_chart" checked>
                              ...
                              <div class="mb-3">
                                 ...
                                 <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="include_statistik" name="include_statistik" checked>
   ...
   <script>
      ...
      async function handleCreateForm(event) {
         ...
         const loadingAlert = alertSystem.loading('Membuat laporan...');
         ...
         try {
            ...
            if (result.success) {
               alertSystem.createSuccess('Laporan');
      ...
      document.addEventListener('DOMContentLoaded', function() {
         ...
         document.getElementById('periode_mulai').value = thirtyDaysAgo.toISOString().split('T')[0];
         document.getElementById('periode_selesai').value = today.toISOString().split('T')[0];
      });
   </script>
