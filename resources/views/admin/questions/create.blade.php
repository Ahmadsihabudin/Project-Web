         ...
         <div class="p-4">
            ...
            <div class="page-header">
               <div class="row align-items-center">
                  <div class="col-md-8">
                     <h4 class="mb-2"><i class="bi bi-plus-circle me-2"></i>Tambah Soal</h4>
   ...
   <script>
      ...
      async function handleCreateForm(event) {
         ...
         if (tipeSoal === 'pilihan_ganda') {
            ...
            if (!jawabanBenar) {
               alert('Pilih jawaban yang benar (A, B, C, atau D)!');
               return;
            }
         }
         ...
         try {
            ...
            const questionData = {
               batch: formData.get('batch') && formData.get('batch') !== 'undefined' ? formData.get('batch') : null,
