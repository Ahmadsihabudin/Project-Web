    ...
    public function run(): void
    {
        ...
        $questions = [
            ...
            [
                ...
                'level_kesulitan' => 'sedang',
                'tipe_soal' => 'pilihan_ganda',
                'opsi_a' => 'Karbondioksida dan air',
                'opsi_b' => 'Glukosa dan oksigen',
                'opsi_c' => 'Klorofil dan air',
                'opsi_d' => 'Glukosa dan karbondioksida',
                'jawaban_benar' => 'b',
                'poin' => 3,
                'status' => 'aktif'
            ],
            ...
            [
                'id_batch' => $batch->id_batch,
                'id_ujian' => $ujian->id_ujian,
                'pertanyaan' => 'Teori relativitas khusus Einstein menjelaskan tentang?',
                'mata_pelajaran' => 'Fisika',
                'level_kesulitan' => 'sulit',
                'tipe_soal' => 'pilihan_ganda',
                'opsi_a' => 'Gravitasi dan waktu',
                'opsi_b' => 'Ruang dan waktu pada kecepatan tinggi',
                'opsi_c' => 'Energi dan massa',
                'opsi_d' => 'Kecepatan cahaya dan energi',
                'jawaban_benar' => 'b',
                'poin' => 5,
                'status' => 'aktif'
            ],
